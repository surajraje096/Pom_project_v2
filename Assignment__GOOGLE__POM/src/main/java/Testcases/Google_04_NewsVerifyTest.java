...
import pages.Google_04_NewsVerifyPage;


public class Google_04_NewsVerifyTest extends TestBase{
	...
	public void setBrowser() throws IOException {
		...
		g4 = Google_03_newsPage.clickonSigninButton();
		g4 = new Google_04_NewsVerifyPage();
	}
	@BeforeClass
	public void getTest() throws IOException {

		boolean nj = getTC("Google_04_NewsVerifyTest");
		if (nj == false) {
