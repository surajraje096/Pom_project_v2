...
import pages.Google_04_SearchVerifyPage;


public class Google_04_SearchVerifyTest extends TestBase {
	...
	public void setBrowser() throws IOException {
		...
		g4 = Google_03_SearchPage.clickonSigninButton();
		g4 = new Google_04_SearchVerifyPage();
	}
	@BeforeClass
	public void getTest() throws IOException {

		boolean nj = getTC("Google_04_SearchVerifyTest");
		if (nj == false) {
