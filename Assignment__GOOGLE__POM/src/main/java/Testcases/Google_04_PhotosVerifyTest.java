...
import pages.Google_04_PhotosVerifyPage;

public class Google_04_PhotosVerifyTest extends TestBase {
	...
	public void setBrowser() throws IOException {
		...
		g4 = Google_03_PhotosPage.clickonSigninButton();
		g4 = new Google_04_PhotosVerifyPage();
	}
	@BeforeClass
	public void getTest() throws IOException {

		boolean nj = getTC("Google_04_PhotosVerifyTest");
		if (nj == false) {
