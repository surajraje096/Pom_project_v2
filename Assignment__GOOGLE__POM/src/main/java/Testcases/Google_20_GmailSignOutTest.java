...
import pages.Goolge_20_GmailSignOutPage;
import util.ExcelReader;
import pages.Google_02_Page;


public class Google_20_GmailSignOutTest extends TestBase {
	...
	Google_09_GmailAccountVerifyPage google9page;
	Goolge_20_GmailSignOutPage google20page;
	...
	public void getTest() throws IOException {
		...
		boolean nj = getTC("Google_20_GmailSignOutTest");
		if (nj == false) {
			throw new SkipException("testcase is skipped");
		}
	}
	@Test(dataProvider = "getValue")
	public void gmailsignoutTest(Hashtable<String, String> table) throws InterruptedException {
		google4page.enterId(table.get("Id"));
		Thread.sleep(4000);
	//	google9page = google3page.enterPasswordfor20page(table.get("Password"));
		google9page=google4page.enterPasswordfor9page(table.get("Password"));
		Thread.sleep(4000);
		google9page.clickonAccountButton();
		Thread.sleep(4000);
		google20page=google9page.clickonSignoutButton();
		String f = google20page.getTitle();
		softassert.assertEquals(f,"Google Accounts");
