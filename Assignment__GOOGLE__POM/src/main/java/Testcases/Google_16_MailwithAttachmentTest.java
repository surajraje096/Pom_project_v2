...
public class Google_16_MailwithAttachmentTest extends TestBase {
	...
	public void getTest() throws IOException {
		...
		boolean nj = getTC("Google_16_MailwithAttachmentTest");
		if (nj == false) {
			throw new SkipException("testcase is skipped");
		}
	}
	@Test(dataProvider = "getValue")
	public void mailattachmentTest(Hashtable<String, String> table) throws InterruptedException {
		google4page.enterId(table.get("Id"));
		Thread.sleep(5000);
		google16page = google4page.enterPasswordfor16attachmentpage(table.get("Password"));
		int no = google16page.getattachmentemailsno();
		System.out.println("Emails with Attachment: " + no);
	}
